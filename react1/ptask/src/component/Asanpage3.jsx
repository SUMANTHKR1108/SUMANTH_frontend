...
function Asanpage3() {
  ...
  <>
    <Container className="d-flex justify-content-center align-items-center" style={{ height: '10vh' }}>
      <Button variant="info" style={{ backgroundColor: '#a8dadc', color: '#007bff', height: '40px', width: '70px' }} size="sm">
       <b>Team</b>
      </Button>
      <br/>
...
<>
    ...
    <Card style={{ width: '20rem'}}>
      <Card.Img variant="top" src="https://th.bing.com/th/id/OIP.BUaTmm5c-Y8HjuAXmfY76gHaEo?w=244&h=180&c=7&r=0&o=5&pid=1.7" height={300} />
      <Card.Body>
    ...
    <Col xs={3} md={3}>
    <Card style={{ width: '20rem'}}>
      <Card.Img variant="top" src="https://scholarsnetwork.org/assets/img/team/team-2.jpg" height={300} />
      <Card.Body>
    ...
    <Col xs={3} md={3}>
    <Card style={{ width: '20rem'}}>
      <Card.Img variant="top" src="https://images.crunchbase.com/image/upload/c_pad,h_256,w_256,f_auto,q_auto:eco,dpr_1/rhxs6ya0wmrcyc0e0gki" height={300} />
      <Card.Body>
    ...
    <Col xs={3} md={3}>
    <Card style={{ width: '20rem' }}>
      <Card.Img variant="top" src="https://www.haddoxreid.com/wp-content/uploads/2017/09/Amanda-Queen.jpg" height={300} />
      <Card.Body>
